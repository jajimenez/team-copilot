...
def test_update_user(app: FastAPI, test_client: TestClient, test_admin_user: User):
    ...
    with (
        patch("team_copilot.routers.users.get_us") as mock_get_user,
...
def test_update_user_exists_username(
    ...
    with patch("team_copilot.routers.users.get_us") as mock_get_user:
        # Simulate the returned values of the "get_us" function
        mock_get_user.side_effect = [user, other_user]
