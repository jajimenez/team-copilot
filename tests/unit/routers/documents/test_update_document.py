"""Team Copilot Tests - Unit Tests - Routers - Documents - Update Document."""
...
def test_update_documnt(
    ...
    with (
        ...
        get_doc_mock.side_effect = [doc, None]
...
def test_update_document_exists(
    ...
    with patch("team_copilot.routers.documents.get_doc") as get_doc_mock:
        # Simulate the returned values of the "get_doc" function
        get_doc_mock.side_effect = [doc, other_doc]
