...
def test_update_user(app: FastAPI, test_client: TestClient, admin_user_mock: User):
    ...
    with (
        ...
        get_us_mock.side_effect = [user, None]

        # Configure the "save_user" mock to simulate the fields of the user object that
        # are generated by the database server when updating a user ("updated_at").
...
def test_update_user_exists_username(
    ...
    with patch("team_copilot.routers.users.get_us") as get_us_mock:
        # Simulate the returned values of the "get_us" function
